...
public class TensBoxsPlaces_Level1 : MonoBehaviour
{
    #region Getter
    private static TensBoxsPlaces_Level1 _instance;
    public static TensBoxsPlaces_Level1 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<TensBoxsPlaces_Level1>();
            }
            return _instance;
        }
    }
