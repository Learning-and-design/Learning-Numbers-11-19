...
public class SingleBoxsPlaces_Level1 : MonoBehaviour
{
    #region Getter
    private static SingleBoxsPlaces_Level1 _instance;
    public static SingleBoxsPlaces_Level1 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<SingleBoxsPlaces_Level1>();
            }
            return _instance;
        }
    }
