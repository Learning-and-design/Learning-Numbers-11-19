...
public class DragTens_Level1 : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{

    public static DragTens_Level1 Instance;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (transform.localPosition == MyDragEnd_Pos)
        {
            ...
            {
                Level_1_Game.Instance.CheckTensBoxQuantity();
            }            
