...
public class TenBoxesDrag : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{   

    public static TenBoxesDrag Instance;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
       ...
       // Debug.Log("OnEndDrag");
        ...
        if (transform.localPosition == MyDragEnd_Pos)
        {
            ...
            {
                Level_0_Game.Instance.TensBoxsCard_Placed();  
            }
