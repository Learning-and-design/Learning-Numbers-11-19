...
public class DragNumbImg_Level3 : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{

    #region Getter
    private static DragNumbImg_Level3 _instance;
    public static DragNumbImg_Level3 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<DragNumbImg_Level3>();
            }
            return _instance;
        }
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (transform.localPosition == MyDragEnd_Pos)
        {
            ...
            {
                Level_3_Game.Instance.CheckNumbrsBoxQuantity(ImgVal_i);
            }                      
