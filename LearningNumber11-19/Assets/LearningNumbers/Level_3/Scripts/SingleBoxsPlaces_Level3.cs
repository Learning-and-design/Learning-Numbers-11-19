...
public class SingleBoxsPlaces_Level3 : MonoBehaviour
{
    #region Getter
    private static SingleBoxsPlaces_Level3 _instance;
    public static SingleBoxsPlaces_Level3 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<SingleBoxsPlaces_Level3>();
            }
            return _instance;
        }
    }
    ...
    public void SetPosnOfUnitsBoxs()
    {
