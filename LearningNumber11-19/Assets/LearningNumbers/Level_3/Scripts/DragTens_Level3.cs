...
public class DragTens_Level3 : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{

    #region Getter
    private static DragTens_Level3 _instance;
    public static DragTens_Level3 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<DragTens_Level3>();
            }
            return _instance;
        }
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (transform.localPosition == MyDragEnd_Pos)
        {
            ...
            {
                Level_3_Game.Instance.CheckTensBoxQuantity();
            } 
