...
public class DragBalls_Level4 : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{

    #region Getter
    private static DragBalls_Level4 _instance;
    public static DragBalls_Level4 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<DragBalls_Level4>();
            }
            return _instance;
        }
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (transform.localPosition == MyDragEnd_Pos)
        {
            ...
            {
                Level_4_Game.Instance.CheckBallsBoxQuantity();
            }                      
