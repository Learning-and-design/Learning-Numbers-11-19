...
public class TensBoxsPlaces_Level4 : MonoBehaviour
{
    #region Getter
    private static TensBoxsPlaces_Level4 _instance;
    public static TensBoxsPlaces_Level4 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<TensBoxsPlaces_Level4>();
            }
            return _instance;
        }
    }
