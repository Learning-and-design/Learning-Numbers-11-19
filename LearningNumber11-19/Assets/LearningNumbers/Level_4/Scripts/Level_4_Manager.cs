...
{
    #region Getter
    private static Level_4_Manager _instance;
    public static Level_4_Manager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<Level_4_Manager>();
            }
            return _instance;
        }
    }
    ...
    [Header("Floats")]
    public float IncToValue_f, IncFromValue_f;
    private float Lvl4_BarVal_temp;
    [Header("Bools")]
    private bool paused;
    ...
    void Initial_Set()
    {
        ...
        Lvl4_BarVal_temp = PlayerPrefs.GetFloat(StaticVariables.Level4_BarVal);
        Levels_BarFill[3].fillAmount = Lvl4_BarVal_temp;

        if (PlayerPrefs.GetFloat(StaticVariables.Level4_BarVal) >= 1)
        {
            SkipBtn_AftPlayAgainClicked_Img.enabled = true;
        }
        ///////////////////////////////
    ...
    {
        if (PlayerPrefs.GetFloat(StaticVariables.Level4_BarVal) >= 1f)
            return;

        IncToValue_f = IncToValue_f + ProgressValBarInc_f;

        if (IncToValue_f > Lvl4_BarVal_temp)
        {
            iTween.ValueTo(Levels_BarFill[3].gameObject, iTween.Hash("from", IncFromValue_f, "to", IncToValue_f, "onupdatetarget", gameObject, "onupdate", "UpdateFromValue", "time", 0.5f, "delay", 0.3f, "easetype", iTween.EaseType.linear));
            PlayerPrefs.SetFloat(StaticVariables.Level4_BarVal, IncToValue_f);
            PlayerPrefs.Save();
            //Debug.Log("PlayerPrefs.GetInt(StaticVariables.Level4_BarVal)::::::::::" + PlayerPrefs.GetFloat(StaticVariables.Level4_BarVal));
        }
    }
    void UpdateFromValue(float newval)
    {
        Levels_BarFill[3].fillAmount = IncFromValue_f = newval;
    }
    ...
    public void Exit_Clicked_SkipTut()
    {
        ...
        Level_4_Manager.Is_SecMoreHintShown = true;
        SkipHintBtn_Img.enabled = false;
    ...
    public void Home_Clicked()
    {
        ...
        OffOnBtnsCastPopupTillVO_Completes(_popupObj_temp, false);//from home to anim icons
    ...
    public void PreviousLevel_Clicked_Back()
    {
        ...
        //Level_4_Game.QuesCount_i = 0;
        StaticVariables.Is_FromLvl4_Back = true; //25-04
    ...
    public void ContinueGame_Clicked_Back()
    {
        ...
        {
            Level_4_Game.Instance.RepeatQuestion_VO(0f);
        }
    }
    ...
    //////////////////AfterLvl1_PopUp//////////////////////////
    public void StartGame_AfterLvl3Exit_PopUp_Show() //25-04
    {
        Check_GameState = GameStates.PopUpShow;
    ...
    public void PlayGame_Clicked_AfterLvl3Exit()
    {
        Check_GameState = GameStates.InGame;
        PopUpsVO_AS.Stop();
        EnterPageUI_AfterExitAtLvl1.SetActive(false);
    ...
    public void ReplayLevel_Clicked__AfterLvl3Exit()
    {
        PopUpsVO_AS.Stop();
    ...
    public void Exit_Clicked_SkipLvl4Tut()
    {
        Time.timeScale = 1;
        Check_GameState = GameStates.InGame;
    ...
    public void Continue_Clicked_SkipLvl4Tut()
    {
        Time.timeScale = 1;
        Check_GameState = GameStates.InGame;
        VoiceOver_AS.UnPause();
    ...
    public void PickNextGame_Clicked_SkipSameLvl()
    {
        Check_GameState = GameStates.InGame;
        Application.LoadLevel("0_MenuScene");
    }
    public void Continue_Clicked_SkipSameLvl()
    {
        ...
        if (Level_4_Game.Instance)
        {
            Level_4_Game.Instance.RepeatQuestion_VO(0.3f);
        }
